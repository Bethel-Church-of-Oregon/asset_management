 ...
 *   BB    건물/위치 번호 2자리     예) 01=비전, 02=은혜, 03=조이채플, 04=창고
 *   DD    관리 사역원 번호 2자리   예) 01=예배부, 02=선교부
 *   SSSS  물품 고유번호 4자리      예) 유아방 왼쪽 TV=0001, 오른쪽 TV=0002
 *
 * 하이픈으로 세 덩어리(연도 / 위치·사역원 / 순번)로 끊어 적습니다. 숫자 10자리가
