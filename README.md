...
│    │ └─────── 관리 사역원 번호 2자리 (01 예배부, 02 선교부 …)
│    └───────── 건물/위치 번호 2자리 (01 비전, 02 은혜, 03 조이채플, 04 창고 …)
└──┴─────────── 취득 연도 2자리 (2026년 → 26)
```

하이픈으로 **연도 / 위치·사역원 / 순번** 세 덩어리로 끊어 적습니다. 숫자 10자리가
...
건물/사역원 번호는 **설정** 화면에서 자유롭게 추가·수정할 수 있습니다 (01~99).
...
`YY-BDSSS` (건물 1자리 · 사역원 1자리 · 고유번호 3자리) 로 쓰던 데이터베이스라면
한 번만 실행하면 됩니다.
